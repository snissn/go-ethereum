...
var (
	...
	DBEngineFlag = &cli.StringFlag{
		Name:     "db.engine",
		Usage:    "Backing database implementation to use ('pebble', 'leveldb', or 'treedb')",
...
func SetNodeConfig(ctx *cli.Context, cfg *node.Config) {
	...
	if ctx.IsSet(DBEngineFlag.Name) {
		...
		if dbEngine != rawdb.DBLeveldb && dbEngine != rawdb.DBPebble && dbEngine != rawdb.DBTreedb {
			Fatalf("Invalid choice for db.engine '%s', allowed 'leveldb', 'pebble', or 'treedb'", dbEngine)
		}
